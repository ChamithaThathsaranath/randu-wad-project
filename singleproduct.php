...
<head>
    ...
    <body>
        <!---navbar section---->
         ...
         <section id="product_details" class="left-section">

    <?php while($row = $products->fetch_assoc()) { ?> <!-- Fixed $row variable -->




        <div class="single-pro-image">
            <img src="Pictures/<?php echo $row['product_image']; ?>" width="100%" id="Main-image" alt="">
        </div>

        <div class="single_pdetails" data-price="18000">
            <h1 id="product-name"><?php echo $row['product_name']; ?>.</h1>
            <h2 id="Price">Rs. <?php echo $row['product_price']; ?></h2>     
...
<input type="hidden" name="product_price" value="<?php echo $row['product_price']; ?>"/>
            ...
            <button type="submit" class="by-btn"  name="add_to_cart"> add to cart</button>
